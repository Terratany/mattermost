// Copyright (c) 2015-present JurisLive, Inc. All Rights Reserved.
...
const baseManifestJSON = `{
  ...
  "name": "JurisLive",
  "short_name": "JurisLive",
  "orientation": "any",
  "display": "standalone",
  "start_url": ".",
  "description": "JurisLive is an open source, self-hosted Slack-alternative",
